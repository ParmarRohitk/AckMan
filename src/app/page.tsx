    ...
    <div className="relative w-full min-h-screen overflow-hidden cursor-none">
      <main className="relative w-full min-h-screen flex items-center justify-center px-4 pt-24">
        ...
        <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              <h1 className="text-6xl lg:text-7xl font-bold">
                <span className="bg-gradient-to-r from-purple-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">Smart Audit</span>
                <br />
                <span className="bg-gradient-to-r from-purple-300 to-blue-400 bg-clip-text text-transparent">Compliance Made Easy</span>
              </h1>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-200/30 to-purple-200/30 rounded-2xl blur-2xl" />
